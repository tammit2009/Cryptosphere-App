...
const getData = async () => {
    const resp = await fetch(`${base_url}/api/v1/tech_analytics/BTCBUSD/4h`);
...
const renderChart = async () => {
    ...
    // add event listeners
    btnSubmitSymbolEl.addEventListener('click', () => {
        console.log('Selected Interval', selectIntervalEl.value);
        console.log('Selected Symbol',   selectSymbolEl.value);
    });
